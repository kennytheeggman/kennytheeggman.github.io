const meta = [
    ...
    ["Matthew Chen", 7, 4, 2, "Althouse"],
    ["Stephanie Cheng", 9, 5, 9, "Althouse"],
    ...
    ["Ramil Jiwani", 5, 6, 7, "Althouse"],
    ["Angad Khattra", 5, 7, 2, "Althouse"],
    ["Rafael Khaykin", 6, 7, 6, "Althouse"],
    ["Louis L'ahelec", 5, 8, 8, "Althouse"],
    ["David Lee", 5, 3, 3, "Althouse"],
    ["Akshita Nath", 7, 4, 8, "Althouse"],
    ["Caylee Pan", 6, 3, 7, "Althouse"],
    ["Iris Park", 4, 4, 7, "Althouse"],
    ["Andrei Petrut", 6, 6, 3, "Althouse"],
    ["Noam Pringle", 4, 7, 10, "Althouse"],
    ["Amy Qian", 3, 4, 8, "Althouse"],
    ["Stephen Tang", 7, 4, 4, "Althouse"],
    ["Bea Tierney", 3, 7, 1, "Althouse"],
    ["Violette Wu", 8, 2, 8, "Althouse"],
    ["Jessica Yi", 7, 2, 8, "Althouse"],
    ["Julian Zhang", 6, 5, 5, "Althouse"],
    ["Jacob Bifolchi", 5, 8, 2, "Cody"],
    ["Charles Binnie", 7, 6, 10, "Cody"],
    ["Moineau Binon", 7, 5, 7, "Cody"],
    ["Gianna Fung", 6, 4, 7, "Cody"],
    ["Leyan He", 5, 2, 6, "Cody"],
    ["Kenny Huang", 5, 5, 3, "Cody"],
    ["Raihan Ibnsharif", 6, 9, "Cody"],
    ["Nameer Issani", 6, 6, 9, "Cody"],
    ["Anthony Javornik", 7, 8, 10, "Cody"],
    ["John Jiang", 4, 5, 2, "Cody"],
    ["Ashwin Krishan", 6, 7, 1, "Cody"],
    ["Tianyi Li", 6, 2, 8, "Cody"],
    ["Olivia Markow", 6, 6, 2, "Cody"],
    ["Halley Martynov", 6, 8, 1, "Cody"],
    ["Eleanora Melkonian", 8, 9, 1, "Cody"],
    ["Siddhesh Mittra", 8, 6, 3, "Cody"],
    ["Tiffany Mok", 7, 3, 2, "Cody"],
    ["Preanka Narenthiren", 7, 11, 1, "Cody"],
    ["Nicola Phillips", 6, 8, 2, "Cody"],
    ["Oliad Rundassa", 5, 8, 7, "Cody"],
    ["Eden Silverberg", 4, 10, 8, "Cody"],
    ["Kaveen Sivakumaran", 6, 11, 7, "Cody"],
    ["Sophia Smith", 6, 5, 4, "Cody"],
    ["Anika Thayaparen", 5, 10, 1, "Cody"],
    ["Sophia Wang", 6, 4, 2, "Cody"],
    ["Michael Wei", 7, 3, 1, "Cody"],
    ["Lauren Weintraub", 6, 9, 9, "Cody"],
    ["Ethan Wu", 5, 2, 4, "Cody"],
    ["Allen Yang", 5, 4, 3, "Cody"],
    ["Thomas Yang", 6, 4, 3, "Cody"],
    ["Julian Bauer-Kong", 6, 10, 6, "Crawford"],
    ["Blake Bissell", 5, 7, 2, "Crawford"],
    ["Graham Chapman", 6, 7, 9, "Crawford"],
    ["William Chiu", 7, 4, 6, "Crawford"],
    ["Trinity Chung", 7, 5, 8, "Crawford"],
    ["Sofia Finelli", 5, 7, 9, "Crawford"],
    ["Jason Fu", 5, 2, 7, "Crawford"],
    ["Olivia Hainsworth", 6, 10, 2, "Crawford"],
    ["Liana Jia", 5, 3, 2, "Crawford"],
    ["Anikah Kalam-Chowdhury", 6, 15, 4, "Crawford"],
    ["Grace Ko", 5, 2, 1, "Crawford"],
    ["Olivia Li Ngan Sun", 6, 11, 3, "Crawford"],
    ["Brandon Ling", 7, 4, 3, "Crawford"],
    ["Zara Mamdani", 4, 7, 9, "Crawford"],
    ["Aahil Noor Ali", 5, 8, 9, "Crawford"],
    ["Pranav Reddy", 6, 5, 7, "Crawford"],
    ["Amy Seglins", 3, 7, 9, "Crawford"],
    ["Evelyn Seiden", 6, 6, 4, "Crawford"],
    ["Archie Shou", 6, 4, 6, "Crawford"],
    ["Emma Syme", 4, 4, 9, "Crawford"],
    ["Sherry Tse", 6, 3, 9, "Crawford"],
    ["Amrita Veeraragavan", 6, 12, 1, "Crawford"],
    ["Aiden Wang", 5, 4, 8, "Crawford"],
    ["Janice Wang", 6, 4, 2, "Crawford"],
    ["Nathan Wang", 6, 4, 3, "Crawford"],
    ["Lauren Willson", 6, 7, 8, "Crawford"],
    ["Emily Xia", 5, 3, 8, "Crawford"],
    ["Kallie Zhang", 6, 5, 7, "Crawford"],
    ["Alina Zhao", 5, 4, 8, "Crawford"],
    ["Liyad Ahmed", 5, 5, 4, "Lewis"],
    ["Layla Al-Ani", 5, 6, 2, "Lewis"],
    ["Aidan Cheng", 5, 5, 2, "Lewis"],
    ["Alexandra Cole", 9, 4, 9, "Lewis"],
    ["Finn Connell", 4, 7, 2, "Lewis"],
    ["Kevin Guo", 5, 3, 3, "Lewis"],
    ["Celena Guo", 6, 3, 3, "Lewis"],
    ["John Hu", 4, 2, 2, "Lewis"],
    ["Hugo Ip", 4, 2, 1, "Lewis"],
    ...
    ["Carina Lai", 6, 3, 9, "Lewis"],
    ["Zora Lakhera", 4, 7, 7, "Lewis"],
    ["Cindy Li", 5, 2, 2, "Lewis"],
    ["Allen Lian", 5, 4, 7, "Lewis"],
    ["Julia Plotkin", 5, 7, 6, "Lewis"],
    ["Jasmine Ren", 7, 3, 3, "Lewis"],
    ["Eshaal Sajid", 6, 5, 7, "Lewis"],
    ["Sarah Ann Siller", 9, 6, 8, "Lewis"],
    ["Avielle Spector-Bloch", 7, 13, 2, "Lewis"],
    ["Gabriel Tian", 7, 4, 3, "Lewis"],
    ["Edwin Wang", 5, 4, 7, "Lewis"],
    ["Matthew Wong", 7, 4, 4, "Lewis"],
    ["Nicole Wong", 6, 4, 3, "Lewis"],
    ["Jeffery Zhang", 7, 5, 3, "Lewis"],
    ["Karen Zhang", 5, 5, 3, "Lewis"],
    ["William Zhou", 7, 4, 3, "Lewis"]
];
